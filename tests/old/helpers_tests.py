...
def value(age, skill):
    age01 = helpers.normalize(age, sfm_glob.PLAYER['AGE']['MIN'], sfm_glob.PLAYER['AGE']['MAX'])
    skill01 = helpers.normalize(skill, 0, sfm_glob.PLAYER['SKILL']['MAX'])

    stop_potential_age01 = helpers.normalize(sfm_glob.PLAYER['AGE']['MIN_FOR_RETIREMENT AGE'], sfm_glob.PLAYER['AGE']['MIN'], sfm_glob.PLAYER['AGE']['MAX'])
    max_skill_increase01 = sfm_glob.PLAYER['TRAINING']['MAXIMUM_SKILL_INCREASE']
