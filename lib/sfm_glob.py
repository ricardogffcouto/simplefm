...
TEAM = {
    ...
    'MIN_DIV_SKILL' : 4,
    'MAX_SKILL' : 20,
    'ATK TACTICS': [[3, 3, 4], [3, 4, 3]],
    'DEF TACTICS': [[5, 3, 2], [5, 4, 1]],
    'BASE TACTICS' : [[3, 5, 2], [4, 3, 3], [4, 4, 2], [4, 5, 1]],
    'TACTICS' : [[3, 4, 3], [4, 3, 3], [4, 4, 2], [4, 5, 1], [3, 5, 2]],
    'TACTICAL_PENALTIES':{
        'DF <= 2': 0.2,
        'DF == 3': 0.525,
        'DF == 5': 1,
    ...
    'AVG_YOUTH_PLAYERS_PROMOTED_PER_YEAR' : 2,
    'BENCH_PLAYERS' : 7,
    "STARTING_AMOUNT_OF_PLAYERS_PER_POS": [2, 6, 6, 4]
}

TEAM_GOALS = {
    'MIN_POINTS_PER_WEEK' : 0.8,
    'MAX_POINTS_PER_WEEK' : 1.8,
...
PLAYER = {
    ...
    'RETIREMENT AGE' : 32,
    'AGE STD DEV': 3.8,
    'SALARY_FOR_SKILL_POW': 0.365,
    'MIN_SALARY' : 2650,
    'MIN_SALARY_INCREASE' : 1.1,
    'MAX_SALARY_INCREASE' : 1.25,
    'MIN_SALARY_INCREASE_NOT_ASKING' : 1,
    'MAX_SALARY_INCREASE_NOT_ASKING' : 1.1,
