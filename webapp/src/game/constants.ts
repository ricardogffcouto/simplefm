...
export const MONEY = {
  ...
  'MIN PER WIN': 39000,
  'MIN PER DRAW': Math.floor(39000 / 3.0),
  'MIN_SPONSORS': 75000,
...
export const TRANSFERS = {
  'LAST_WEEK': Math.floor(COMPETITION['TOTAL GAMES'] * 0.8),
...
export const PLAYER_TRAINING = {
  MAX:
    ((PLAYER['MAX_SKILL'] * 0.55) /
      (COMPETITION['TOTAL GAMES'] * (PLAYER['AVG AGE'] - PLAYER['MIN AGE']))),
...
export const MATCH = {
  'GOAL PROB PER POSITION': [0, 0.03, 0.09, 0.88] as const,
